...
public class RegistrationEmail {
    ...
    public String sendEmail() throws Exception
    {
		...
		message.setContent("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><!--[if IE]><html xmlns=\"http://www.w3.org/1999/xhtml\" class=\"ie\"><![endif]--><!--[if !IE]><!--><html style=\"margin: 0;padding: 0;\" xmlns=\"http://www.w3.org/1999/xhtml\"><!--<![endif]--><head>\n" +
                    ...
                    "Registered Email: "+registeredEmail+"<br>Password: "+registeredPassword+"</p><p style=\"Margin-top: 20px;Margin-bottom: 20px;\">We recommend you to change your password immediately by logging into the app.</p>\n" +
                    "      </div>\n" +
                    "    </div>\n" +
                    "        \n" +
                    "            <div style=\"Margin-left: 20px;Margin-right: 20px;\">\n" +
                    ...
                    "                  <div>You are receiving this email as your account has been registered by your college</div>\n" +
                    "                </div>\n" +
                    "                <!--[if mso]>&nbsp;<![endif]-->\n" +
                    "              </div>\n" +
                    "            </div>\n" +
